...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post p1 = new Post(null, sdf.parse("02/01/2023"), "Title 01", "Content 01", u1);
		Post p2 = new Post(null, sdf.parse("03/01/2023"), "Title 02", "Content 02", u1);
		Post p3 = new Post(null, sdf.parse("02/01/2023"), "Title 03", "Content 03", u2);
